...
def optimize(params, x, y):
    ...
    This function takes all the arguments from the search space and training features and targets. It then initializes
    the models by setting the chosen parameters and runs cross-validation and returns a negative accuracy score :param params: dict of params from hyperopt
...
if __name__ == "__main__":
    ...
    # note that there is no id column in this dataset # here we have training features
